...
const AllSongsIndex = () => {
  ...
  return (
    <div>
    <h2>Listen to Our Latest Uploads</h2>
    <div className='songLibrary'>
        {
          songs?.map(song => (
            ...
            <div className='soundWave'>
                <img className='soundImage' alt="" src="https://images.fineartamerica.com/images/artworkimages/mediumlarge/3/led-zeppelin-thank-you-sound-wave-art-soundwave-art.jpg"></img>
            </div>
            </div>
          ))
        }
